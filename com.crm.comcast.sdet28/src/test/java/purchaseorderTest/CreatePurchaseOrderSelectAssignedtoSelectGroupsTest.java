...
public class CreatePurchaseOrderSelectAssignedtoSelectGroupsTest extends BaseClass {
	//@Test(groups= {"smokeTest"})
	@Test(groups= {"regressionTest"})
	public void createPurchaseOrderSelectAssignedToGroup() throws Throwable {
