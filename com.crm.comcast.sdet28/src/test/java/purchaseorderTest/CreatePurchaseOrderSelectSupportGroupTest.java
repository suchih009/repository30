 ...
 * and select support groups
 * @author suchi
 *
 */

public class CreatePurchaseOrderSelectSupportGroupTest extends BaseClass {
	...
	public void createPurchaseOrderSelectSupportGroup() throws Throwable {
		//create an object for utilities
		        ...
		        //.clickOnAssignedToDropDown();
		        createpurchaseOrderPage.clickOnAssignedToDropDown();
				//createpurchaseOrderPage.clickOnGroupRadioButton();
				//createpurchaseOrderPage.selectAssignedToDropDownList();
				createpurchaseOrderPage.selectSupportGroupDropDownList();
				...
				String actual="ShippingAddress";
				String expected="ShippingAddress";
